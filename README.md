...
## Description
- It is a simple fitness application
---

##  Table of Contents

- [Fitness - Platform](#fitness---platform)
...
- https://github.com/SowmyaT-157/fitness-platform-backend
...
* To run the application, first build the application by using given command.
```bash
    npm run build
```
* If you can run the application use below command
```bash
    npm run start
  ```
